...
BATCH_SIZES = [128, 64, 64, 64, 32, 16]  # change depending on vram
...
# in paper they did 800k img per epoch; TODO: we're doing 30 * dataset
PROGRESSIVE_EPOCHS = [4, 8, 16, 20, 30]
PROGRESSIVE_EPOCHS = [1, 2, 4, 8, 16, 20]
# image sizes         4  8  16  32  64 128 256 512 1024
